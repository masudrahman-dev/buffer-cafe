...
for category in data["categories"]:
    print(f"Category ID: {category['idCategory']}")
    print(f"Category Name: {category['strCategory']}")
    print(f"Category Thumbnail: {category['strCategoryThumb']}")
    print(f"Category Description: {category['strCategoryDescription']}")
    print("\n")
